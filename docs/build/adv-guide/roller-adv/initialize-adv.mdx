...
Sequencer <chain-id> | Address used to publish state updates to the Dymension Hub
Relayer   <chain-id> | Address that handles the relaying of IBC packets
DA        <chain-id> | Address used to publish data on-chain to the DA network
```

...
2. Enter your RollApp ID:
    <br />
    Format: rollapp-name_EIP155-revision. e.g wagmi_420-1
2. Specify your RollApp denom:
    <br />
    e.g BTC, PEPE, DYM
3. How many tokens do you wish to mint for Genesis? (default: 1,000,000,000):
    <br />
    These are the amount of tokens in denom (i.e. ETH, BTC)
4. Choose your data layer:
    <br />
    Defaults to Celestia Mocha network, with more DA added soon.
5. Set your runtime binary. for EVM RollApp hit ‘Enter’. For a custom app-specific RollApp, input it’s binary path:
    <br />
    If you're using this quick start guide it is recommended to press `Enter` else we recommend continuing with the advanced guide

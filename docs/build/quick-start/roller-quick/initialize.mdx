...
Additionally, for Celestia network tokens users may use the `celestia-faucet` [channel](https://discord.com/channels/956961633165529098/1128048548999610451) on the Dymension discord with the following command as an example:

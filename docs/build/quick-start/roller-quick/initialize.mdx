...
- Set your runtime binary. for EVM RollApp hit ‘Enter’.
    - If you're using this quick start guide it is recommended to press `Enter` else we recommend continuing with the [advanced guide](/build/adv-guide/roller-adv/install-adv)

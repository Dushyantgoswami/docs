...
<div>
    ...
    <summary>hub (optional)</summary>
        ...
        <div><b>- Local</b>: Local development environment requires running a localhost Dymension Hub full node, please visit <a href="/validate/dymension-hub/build-dymd?network=localhost">here</a>
        to run a localhost node.</div>
        <div><b>- Froopyland</b>: Very Soon</div>
...
<div>
    ...
    <summary>da (optional)</summary>
        <div>The DA layer for the RollApp. Can be one of 'Celestia, Avail, Mock' (default "Celestia"). Mock is available when "hub" local is selected and a localhost full node is in-process.</div>
    </details>
</div>

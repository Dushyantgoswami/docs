...
<div>
    ...
    <div>
        <div><b>- Devnet (default)</b>: Non-incentivized public Devnet for building and testing. Requires faucet tokens for selected DA network and Dymension Hub.</div>
        <div><b>- Local</b>: Optional Mock DA network (no faucet tokens needed) included. Requires running a localhost Dymension Hub full node please visit <a href="/validate/dymension-hub/build-dymd">here </a>
        to run a node.</div>
...
<div>
    ...
    <summary>Select your execution environment</summary>
        ...
        <div><b>- <a href="/build/adv-guide/rdk/setup/rdk-repo">RDK</a></b>: Requires specifying runtime binary path (e.g. /usr/local/bin/rollapp)</div>
    </details>
</div>
...
<div>
    ...
    <summary>hub (optional)</summary>
        ...
        <div><b>- Local</b>: Uses localhost Dymension Hub node (please visit <a href="/validate/dymension-hub/build-dymd">here </a> to run a node) and mock DA network</div>
        <div><b>- Froopyland</b>: Very Soon</div>
...
<div>
    ...
    <summary>da (optional)</summary>
        <div>The DA layer for the RollApp. Can be one of 'Celestia, Avail, Mock' (default "Celestia")</div>
    </details>
</div>
...
<div>
    ...
    <summary>vm-type (optional)</summary>
        <div>RollApp type [evm, sdk]. Defaults to EVM (default "evm")</div>
    </details>
</div>
...
```
$request celestia1emd05tmxqy5z9mlccvudrmj8hnmds49t2le2r2
```
</TabItem>
<TabItem value="Avail funding" label="Avail funding">
For Avail network tokens users may use the <b>dymension-faucet</b> channel on <a href="https://discord.gg/fzbbcKDuUb">Avail's discord</a> with the following command as an example:

```
/deposit 5CX88GGvxDia5v6fkzwdvTCpqvvEHFo1oKujayxqjzejhP9e
```
</TabItem>
</Tabs>
